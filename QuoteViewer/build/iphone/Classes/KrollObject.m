...
//@interface QuoteViewerObject : NSObject
//@end

@interface QuoteViewerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[QuoteViewerObject class]])
		{
			for (NSString *key in [[(QuoteViewerObject*)o modules] allKeys])
			{
