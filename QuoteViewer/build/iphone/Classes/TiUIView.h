...
/**
 Base class for all QuoteViewer views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the QuoteViewer view hierarchy (such as wrapped iOS UIViews) was touched.
