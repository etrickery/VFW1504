...
// in simulator we redefine to format for QuoteViewer Developer console
...
{\
	NSString * exceptionName = [@"org.quoteviewer." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.quoteviewer";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIQuoteViewerNativeItemNone = -1, 
	UIQuoteViewerNativeItemSpinner = -2,
	UIQuoteViewerNativeItemProgressBar = -3,
	
	UIQuoteViewerNativeItemSlider = -4,
	UIQuoteViewerNativeItemSwitch = -5,
	UIQuoteViewerNativeItemMultiButton = -6,
	UIQuoteViewerNativeItemSegmented = -7,
	
	UIQuoteViewerNativeItemTextView = -8,
	UIQuoteViewerNativeItemTextField = -9,
	UIQuoteViewerNativeItemSearchBar = -10,
	
	UIQuoteViewerNativeItemPicker = -11,
	UIQuoteViewerNativeItemDatePicker = -12,
	
	UIQuoteViewerNativeItemInfoLight = -13,
	UIQuoteViewerNativeItemInfoDark = -14,
	
	UIQuoteViewerNativeItemDisclosure = -15,
	
	UIQuoteViewerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all QuoteViewer instances of
