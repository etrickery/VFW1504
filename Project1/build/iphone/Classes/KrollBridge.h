...
@interface QuoteViewerObject : KrollCoverageObject {
#else
@interface QuoteViewerObject : KrollObject {
#endif
@private
...
extern NSString * QuoteViewer$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	QuoteViewerObject *_quoteviewer;
    KrollObject* console;
	BOOL shutdown;
