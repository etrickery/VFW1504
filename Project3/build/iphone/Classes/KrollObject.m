...
//@interface Project3Object : NSObject
//@end

@interface Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Project3Object class]])
		{
			for (NSString *key in [[(Project3Object*)o modules] allKeys])
			{
