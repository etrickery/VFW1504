...
// in simulator we redefine to format for Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProject3NativeItemNone = -1, 
	UIProject3NativeItemSpinner = -2,
	UIProject3NativeItemProgressBar = -3,
	
	UIProject3NativeItemSlider = -4,
	UIProject3NativeItemSwitch = -5,
	UIProject3NativeItemMultiButton = -6,
	UIProject3NativeItemSegmented = -7,
	
	UIProject3NativeItemTextView = -8,
	UIProject3NativeItemTextField = -9,
	UIProject3NativeItemSearchBar = -10,
	
	UIProject3NativeItemPicker = -11,
	UIProject3NativeItemDatePicker = -12,
	
	UIProject3NativeItemInfoLight = -13,
	UIProject3NativeItemInfoDark = -14,
	
	UIProject3NativeItemDisclosure = -15,
	
	UIProject3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Project3 instances of
