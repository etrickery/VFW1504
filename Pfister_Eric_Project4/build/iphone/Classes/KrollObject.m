...
//@interface Pfister_Eric_Project4Object : NSObject
//@end

@interface Pfister_Eric_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Pfister_Eric_Project4Object class]])
		{
			for (NSString *key in [[(Pfister_Eric_Project4Object*)o modules] allKeys])
			{
