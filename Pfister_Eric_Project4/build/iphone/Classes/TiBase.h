...
// in simulator we redefine to format for Pfister_Eric_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.pfister_eric_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pfister_eric_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPfister_Eric_Project4NativeItemNone = -1, 
	UIPfister_Eric_Project4NativeItemSpinner = -2,
	UIPfister_Eric_Project4NativeItemProgressBar = -3,
	
	UIPfister_Eric_Project4NativeItemSlider = -4,
	UIPfister_Eric_Project4NativeItemSwitch = -5,
	UIPfister_Eric_Project4NativeItemMultiButton = -6,
	UIPfister_Eric_Project4NativeItemSegmented = -7,
	
	UIPfister_Eric_Project4NativeItemTextView = -8,
	UIPfister_Eric_Project4NativeItemTextField = -9,
	UIPfister_Eric_Project4NativeItemSearchBar = -10,
	
	UIPfister_Eric_Project4NativeItemPicker = -11,
	UIPfister_Eric_Project4NativeItemDatePicker = -12,
	
	UIPfister_Eric_Project4NativeItemInfoLight = -13,
	UIPfister_Eric_Project4NativeItemInfoDark = -14,
	
	UIPfister_Eric_Project4NativeItemDisclosure = -15,
	
	UIPfister_Eric_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Pfister_Eric_Project4 instances of
