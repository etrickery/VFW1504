...
//Rare exceptions to indicate a bug in the _pfister_eric_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Pfister_Eric_Project4 proxies.
 */
