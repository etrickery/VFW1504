 ...
 * to send analytic data that can be viewed on the Pfister_Eric_Project4 Dashboard.
 *
 * For information on getting started with Pfister_Eric_Project4 Platform Services,
