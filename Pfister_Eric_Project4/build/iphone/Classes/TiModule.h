...
/**
 The base class for all Pfister_Eric_Project4 modules
 */
...
/**
 Pfister_Eric_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Pfister_Eric_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Pfister_Eric_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Pfister_Eric_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Pfister_Eric_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
