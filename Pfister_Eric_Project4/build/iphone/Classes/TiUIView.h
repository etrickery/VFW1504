...
/**
 Base class for all Pfister_Eric_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Pfister_Eric_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
