...
@interface Pfister_Eric_Project4Object : KrollCoverageObject {
#else
@interface Pfister_Eric_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Pfister_Eric_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Pfister_Eric_Project4Object *_pfister_eric_project4;
    KrollObject* console;
	BOOL shutdown;
